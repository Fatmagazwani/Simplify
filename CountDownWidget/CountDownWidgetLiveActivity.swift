...
struct CountDownWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = CountDownWidgetAttributes(name: "Me")
    static let contentState = CountDownWidgetAttributes.ContentState(value: 3)
